...
<body>
    ...
    <div class="container" id="cajon">
        <div class="caja caja1">
            <a href="{{ url('/maderas?categoria=Suelos+de+Madera') }}">Suelos de Madera</a> 
        </div>
        <div class="caja caja1">
            <a href="{{ url('/maderas?categoria=Suelos+de+Vinilo') }}">Suelos de Vinilo</a>
        </div>
        <div class="caja caja1">
            <a href="{{ url('/maderas?categoria=Suelos+Laminados') }}">Suelos Laminados</a>
        </div>
        <div class="caja caja1">
            <a href="{{ url('/maderas?categoria=Tarimas+Exteriores') }}">Tarimas Exteriores</a>
        </div>
    </div>
</body>