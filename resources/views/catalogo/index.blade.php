...
<table class="table table-light">
    ...
    <tbody>
        ...
        <tr>
            ...
            @if(Auth::user()->tipo_usuario)<td>
            <a href=" {{ url('/maderas/'.$maderas->id.'/edit') }} " class="btn btn-primary">Editar</a> 
            |     
            <form action="{{ url('/maderas/'.$maderas->id) }}" class="d-inline" method="post">
            @csrf
            {{ method_field('DELETE') }}
